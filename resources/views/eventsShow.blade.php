<x-main-layout>
    <div class="m-2 p-2 flex justify-between">
        ...
        <div class="flex space-x-2">
            From:
            <span class="mx-2 text-indigo-700">{{ $event->start_date->format('m/d/Y') }}</span> | <span
                class="mx-2 text-indigo-700">{{ $event->end_date->format('m/d/Y') }}</span>
        </div>
    </div>
    <div class="mb-16 flex flex-wrap dark:bg-gray-800">
        ...
        <div class="w-full shrink-0 grow-0 lg:w-6/12 lg:pl-6 dark:bg-gray-800 rounded-md p-2">
            ...
            @auth
                <div
                    class="container d-flex justify-content-center align-items-center w-50 mt-6 p-4 rounded-md">
                    <div class="">
